...
export default async function CalidadListPage() {
  ...
  if (session?.user.rol !== 'calidad' && session?.user.rol !== 'superadmin') redirect('/login')
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm mt-1" style={{ color: 'var(--sica-muted)' }}>
            Ingresos pendientes de firma — Etapa 2
          </p>
        </div>
        <div className="flex items-center gap-2 px-4 py-2 rounded-lg" style={{ background: 'rgba(26,154,214,0.1)', border: '1px solid rgba(26,154,214,0.2)' }}>
          <ClipboardCheck size={16} style={{ color: 'var(--sica-blue)' }} />
